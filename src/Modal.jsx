    ...
    return (
        ...
        >
            ...
            <div 
                ref={nodeRef} 
                onMouseDown={(e) => {
                    e.stopPropagation(); // Prevents the click from reaching modals or folders behind this one
                    setFocusedModal(modalId);
                }}
                className="absolute top-0 left-0"
                style={{ touchAction: 'none', zIndex: isFocused ? 100 : 50 }}
            >
